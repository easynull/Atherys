...
public final class ASComponents {
    ...
    public static Supplier<DataComponentType<Integer>> essential = components.registerComponentType("are", builder -> builder.persistent(Codec.INT).networkSynchronized(ByteBufCodecs.VAR_INT));
