...
import com.easynull.atherys.registers.commands.ResearchCommands;
...
public final class AsEvents {
    public static final Map<ItemStack, List<Component>> lastTooltips = new HashMap<>();

    @SubscribeEvent
    private static void addCipher(ItemTooltipEvent event){
