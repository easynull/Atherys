...
public final class EnergyUtils {
    public static void inFrom(Object target, Object source, int amount, boolean inTarget){
        if (!((source instanceof ItemStack s ? s.getItem() : source) instanceof NEnergy source1)) return;
        if (!((target instanceof ItemStack s ? s.getItem() : target) instanceof NEnergy target1)) return;
